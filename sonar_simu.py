...
class Sonar:
    ...
    # 初始化函数
    def init(self, channel=2, rate=192000, times_pre_second=2, ):           # 这里修改了pyaudio “format=pyaudio.paInt16”
    ...
    def _check_need_setp(self, src_data):
        ...
        if not is_location:
            print(
                "i think need auto step no location. first_bit_width=%d, first_one_index=%d, first_negative_one_index=%d" % (
                    first_bit_width, first_one_index, first_negative_one_index))
            return 48000
